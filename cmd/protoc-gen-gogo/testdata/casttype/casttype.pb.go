...
type Castaway struct {
	//AFOO int32
	Int32Ptr *int64 `protobuf:"Int32Ptr" json:"Int32Ptr,omitempty"`
	//AFOO int32
	Int32 *int64 `protobuf:"Int32" json:"Int32,omitempty"`
	//AFOO github.com/gogo/protobuf/test/casttype.MyUint64Type
	MyUint64Ptr *uint64 `protobuf:"MyUint64Ptr" json:"MyUint64Ptr,omitempty"`
	//AFOO github.com/gogo/protobuf/test/casttype.MyUint64Type
	MyUint64 *uint64 `protobuf:"MyUint64" json:"MyUint64,omitempty"`
	//AFOO github.com/gogo/protobuf/test/casttype.MyFloat32Type
	MyFloat32Ptr *float32 `protobuf:"MyFloat32Ptr" json:"MyFloat32Ptr,omitempty"`
	//AFOO github.com/gogo/protobuf/test/casttype.MyFloat32Type
	MyFloat32 *float32 `protobuf:"MyFloat32" json:"MyFloat32,omitempty"`
	//AFOO github.com/gogo/protobuf/test/casttype.MyFloat64Type
	MyFloat64Ptr *float64 `protobuf:"MyFloat64Ptr" json:"MyFloat64Ptr,omitempty"`
	//AFOO github.com/gogo/protobuf/test/casttype.MyFloat64Type
	MyFloat64 *float64 `protobuf:"MyFloat64" json:"MyFloat64,omitempty"`
	//AFOO github.com/gogo/protobuf/test/casttype.Bytes
	MyBytes     []byte `protobuf:"MyBytes" json:"MyBytes,omitempty"`
	NormalBytes []byte `protobuf:"NormalBytes" json:"NormalBytes,omitempty"`
	//AFOO github.com/gogo/protobuf/test/casttype.MyUint64Type
	MyUint64S []uint64 `protobuf:"MyUint64S" json:"MyUint64s,omitempty"`
	//AFOO github.com/gogo/protobuf/test/casttype.MyMapType
	MyMap map[string]uint64 `protobuf:"MyMap" json:"MyMap,omitempty" protobuf_key:"Key" protobuf_val:"Value"`
	//AFOO
	MyCustomMap map[string]uint64 `protobuf:"MyCustomMap" json:"MyCustomMap,omitempty" protobuf_key:"Key" protobuf_val:"Value"`
	//AFOO
	MyNullableMap map[int32]*Wilson `protobuf:"MyNullableMap" json:"MyNullableMap,omitempty" protobuf_key:"Key" protobuf_val:"Value"`
	//AFOO
	MyEmbeddedMap map[int32]*Wilson `protobuf:"MyEmbeddedMap" json:"MyEmbeddedMap,omitempty" protobuf_key:"Key" protobuf_val:"Value"`
	//AFOO github.com/gogo/protobuf/test/casttype.MyStringType
	String_              *string  `protobuf:"String_" json:"String,omitempty"`
...
type Wilson struct {
	Int64                *int64   `protobuf:"Int64" json:"Int64,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
